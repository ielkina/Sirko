...
document.addEventListener("DOMContentLoaded", function () {
  //Mobile Menu
  var burger = document.querySelector(".burger"); //наша кнопка

  var mobileMenu = document.querySelector(".menu"); //мобильное меню

  var bodyLock = document.querySelector("body"); //ищем как селектор ТЕГА
...
$(function () {
  ...
  $(".menu a, .footer__logo").on("click", function (e) {
    ...
    e.preventDefault(); //забираем идентификатор бока с атрибута href
